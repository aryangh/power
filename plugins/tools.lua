--Begin Tools.lua :)
local SUDO = 115740444 -- put Your ID here! <===
...
local text = matches[2]
tdcli.createNewChannelChat(text, 1, '@PowerShield_Team', (function(b, d) tdcli.addChatMember(d.id_, msg.from.id, 0, dl_cb, nil) end), nil)
   if not lang then 
...
if ((matches[1] == 'powershield' and not Clang) or (matches[1] == "بیوند" and Clang)) then
...
_Sudoer And Admins PowerShield Bot Help :_
